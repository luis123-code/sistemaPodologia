...
import { Search, ChevronDown, LogOut, User, Settings, MessageCircle, Send, Code2 } from "lucide-react";
        ...
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuItem asChild className="p-0 focus:bg-transparent">
              <Link
                to="/configuracion"
                className="flex w-full cursor-pointer items-center gap-2 rounded-lg px-2 py-1.5 text-sm outline-none data-[highlighted]:bg-primary/10 data-[highlighted]:text-primary"
              >
