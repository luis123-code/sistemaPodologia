...
export interface WebsiteTemplateSettings {
  ...
  galleryPodologiaProfesional: string[];
  galleryPanel: string[];
}
...
export function loadWebsiteTemplateSettings(): WebsiteTemplateSettings {
  try {
    ...
    return {
      ...
      galleryPodologiaProfesional:
        Array.isArray(parsed.galleryPodologiaProfesional) ? parsed.galleryPodologiaProfesional : base.galleryPodologiaProfesional,
      galleryPanel:
        Array.isArray(parsed.galleryPanel) ? parsed.galleryPanel : base.galleryPanel,
    };
  } catch {
